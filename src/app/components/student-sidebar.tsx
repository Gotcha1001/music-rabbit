...
export function StudentSidebar() {
  ...
  return (
    <>
      {/* ── Mobile backdrop overlay — sits behind sidebar, above page ── */}
      {isMobile && openMobile && (
        <div
      ...
      <Sidebar
        className="border-r border-purple-800/30 bg-[#0a0014]"
        // On mobile the shadcn Sidebar uses data-mobile="true" and fixed positioning;
        // we ensure it always renders above the overlay and page content.
        style={{ zIndex: isMobile ? 50 : undefined }}
      >
        {/* Header */}
        <SidebarHeader className="p-6 border-b border-purple-800/30 bg-gradient-to-br from-purple-950 to-black">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
              <Music className="h-6 w-6 text-white" />
            </div>
        ...
        {/* Footer */}
        <SidebarFooter className="p-4 border-t border-purple-800/30 bg-gradient-to-br from-purple-950 to-black">
          <div className="space-y-4">
            <div className="px-2 py-1">
              <PushNotificationToggle variant="switch" />
            </div>
