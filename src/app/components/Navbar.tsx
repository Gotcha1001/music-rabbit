...
//   return (
//     <motion.nav
//       className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-black via-purple-950 to-black dark:from-black dark:via-purple-950 dark:to-black border-b-2 border-purple-800/30 shadow-[0_0_30px_rgba(168,85,247,0.2)]"
//       initial={{ y: -100, opacity: 0 }}
//       animate={{ y: 0, opacity: 1 }}
//       transition={{ duration: 0.6, ease: "easeOut" }}
//     >
...
export default function Navbar() {
  ...
  return (
    <motion.nav
      className="flex items-center justify-between p-4 bg-blue-600 text-white dark:bg-purple-900"
