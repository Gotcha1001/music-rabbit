...
//   //     if (data.paymentUrl) {
//   //       // Use replace() method to avoid React linting issues
...
//       if (data.paymentUrl) {
//         window.location.replace(data.paymentUrl); // ✅ Use replace instead of href
//       } else {
//         toast.error(data.error || "Failed to create payment session");
//         setPurchasing(null);
//       }
...
//                       disabled={isActive || purchasing === pkg.id}
...
//                     <Button
//                       onClick={() => handlePurchase(pkg)}
//                       disabled={isActive || !!purchasing} // ✅ Disable if ANY package is being purchased
//                       className={`w-full py-6 text-lg ${
//                         isActive
//                           ? "bg-green-600 hover:bg-green-700"
