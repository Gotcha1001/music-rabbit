...
// New component to fix the hook-in-callback issue
function RecordingRow({ recording }: { recording: Doc<"recordings"> }) {
  // Fetch the specific lesson details which includes the date
  ...
  return (
    <TableRow>
      <TableCell>{recording.lessonStringId}</TableCell>
      <TableCell>
        {lesson ? format(new Date(lesson.date), "PPP") : "Loading..."}
      </TableCell>
      <TableCell>{recording.notes || "—"}</TableCell>
      <TableCell>
        <Button
          variant="link"
